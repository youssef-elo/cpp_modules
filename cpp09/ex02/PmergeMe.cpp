...
void PmergeMe::ford_jhonson_sort_vector(std::vector<int> &nums, int unit_size)
{
...
void PmergeMe::sort_numbers(std::vector<int> nums_vec, std::deque<int> nums_deq)
{
	...
	std::cout << std::fixed << std::setprecision(6) << std::endl
			  << "Time to process a range of " << nums_vec.size() << " with std::vector : " << vec_time << " s." << std::endl;
